    ...
    return(
        <div className="UAU">
            <div className="infoalbum">
                ...
                <div className="infoal">
                    <div className="infotext">
                        <Button />
                        <p>- POBs = from  <span className="colordosa"> 6 usd</span></p>
            ...
            <div className="infoalbum">
                ...
                <div className="infoal">
                    <div className="infotext">
                         <p>-Photocard Set = <span className="colorunoa">20 usd set</span> <span className="colordosa"> 5usd ea</span></p>
                            <p>- Trading Cards = <span className="colorunoa">10usd set </span> <span className="colordosa"> 4 usd ea</span></p>
                    </div>
