    ...
    return(
        ...
        <div className="infoal">
          <div className="infotext">
            ...
            <p>- Photobook Limitado (cd+pb) =  <span className="colorunoa">11usd</span> <span className="colordosa"> 10 usd</span></p>
            <p>- Photocard limitada = <span className="colorunoa"> 6 usd</span><span className="colordosa"> 10 usd</span></p>
            <p>- Postcard holográfica = <span className="colorunoa">0,75usd c/u</span> <span className="colordosa"> 5 usd set</span></p>
            <p>- Pop-up Card = <span className="colorunoa">1,75usd</span> <span className="colordosa"> 5 usd</span></p>
            <p>- Apoya vasos = <span className="colorunoa">0,8usd</span> <span className="colordosa"> 0,2 usd</span></p>
            <p>- Poster preventa limitado = <span className="colorunoa">1,5usd</span> <span className="colordosa"> 1 usd</span></p>
